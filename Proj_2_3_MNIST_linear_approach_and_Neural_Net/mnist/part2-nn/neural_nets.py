...
class NeuralNetwork():
    ...
    def train(self, x1, x2, y):
        ...
        output_layer_error = -(y - activated_output) * output_layer_activation_derivative(activated_output)
        hidden_layer_error = np.multiply(output_layer_error, np.multiply(self.hidden_to_output_weights.T,
